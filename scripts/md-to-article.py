#!/usr/bin/env python3
"""
md-to-article.py — LevNytt Publication Source V2 → canonical editorial HTML
...
<p class="ia-disclosure">{LEGAL_DISCLOSURE}</p>
    ...
    return canonicalize_html(source_html, canonical_url, f"content/articles/{slug}/{slug}.html", REPO_ROOT)
